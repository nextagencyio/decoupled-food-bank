...
export const metadata: Metadata = {
  title: 'Events | Community Harvest Food Bank',
  description: 'Upcoming food drives, volunteer events, and community gatherings.',
}
      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-400 mt-6 max-w-xl">
            Upcoming food drives, volunteer events, and community gatherings.
          </p>
        </div>
      </section>
