...
export const metadata: Metadata = {
  title: 'Contact Us | Community Harvest Food Bank',
  description: 'Contact Community Harvest Food Bank. Find food assistance, volunteer opportunities, or make a donation.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 md:pt-48 md:pb-24">
        ...
        <p className="text-lg text-gray-400 mb-16 max-w-xl">
          Need food assistance or want to get involved? We&apos;d love to hear from you.
        </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">(555) 789-0112</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">info@communityharvestfoodbank.org</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">1600 Distribution Drive<br />Indianapolis, IN 46204</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">Mon-Fri: 8am - 5pm<br />Sat: 9am - 12pm (Distributions)</p>
                </div>
              </div>
            </div>
          </div>
