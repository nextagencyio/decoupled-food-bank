...
export const metadata: Metadata = {
  title: 'Programs | Community Harvest Food Bank',
  description: 'Explore our food assistance and community programs.',
}
      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-400 mt-6 max-w-xl">
            Food assistance and community programs for those in need.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-400">Programs will appear here once content is imported.</p>
            </div>
          ) : (
